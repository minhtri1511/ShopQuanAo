...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:DataList ID="dtlSanPham" runat="server" RepeatColumns = "3" Width="703px">
        <ItemTemplate>
         <div class="products">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat ="server">
     <div id="slider_holder" class="theme-default">
        	<div id="slider" class="nivoSlider">
                ...
                <img src="images2/slide_02.jpg" data-thumb="images2/slide_02.jpg" alt="" title="Không còn vẻ cứng nhắc khi đến công sở, những chiếc áo sơ mi thiết kế kiểu cách giúp bạn tự tin , giấu bớt nhược điểm" /></a>
                <img src="images2/slide_03.jpg" data-thumb="images2/slide_03.jpg" alt="" data-transition="slideInLeft" />
                <img src="images2/slide_04.jpg" data-thumb="images2/slide_04.jpg" alt="" title="#htmlcaption" />
                <img src="images2/slide_05.jpg" data-thumb="images2/slide_05.jpg" alt="" title="#htmlcaption" />
